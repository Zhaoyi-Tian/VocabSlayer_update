...
from client.start_ai import Ui_Form
...
class StartWidget(QWidget, Ui_Form):
    ...
    def __init__(self, VLS:VocabularyLearningSystem,parent=None):
        ...
        self.StrongBodyLabel.setVisible(False)
        self.PushButton.clicked.connect(self.ask_ai)
    def ask_ai(self):
        self.IndeterminateProgressRing.setVisible(True)
        self.StrongBodyLabel.setVisible(True)
...
# 考试系统主容器
class aireviewContainer(QWidget):
