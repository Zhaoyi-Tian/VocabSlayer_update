...
class StartWidget(QWidget, Ui_Form):
    ...
    def __init__(self, VLS:VocabularyLearningSystem,parent=None):
        ...
        self._init_ui()
        self.VLS = VLS
        self.ComboBox.addItems(["level1", "level2","level3"])
        self.ComboBox.setPlaceholderText("请选择难度")
        ...
        self.ComboBox.currentIndexChanged.connect(lambda i: self.update_level(i))
