...
class QuestionWidget(QWidget):
    ...
    def _create_question_pages(self):
        ...
        ui1 = Ui_fanyi()
        ui1.setupUi(page1)
        ui1.LargeTitleLabel.setText(f"欢迎使用万词斩, {self.username}")
        ...
        ui2 = Ui_fanyi()
        ui2.setupUi(page2)
        ui2.LargeTitleLabel.setText(f"欢迎使用万词斩, {self.username}")
        ...
        ui3 = Ui_fanyi()
        ui3.setupUi(page3)
        ui3.LargeTitleLabel.setText(f"欢迎使用万词斩, {self.username}")
        ...
        ui4 = Ui_fanyi()
        ui4.setupUi(page4)
        ui4.LargeTitleLabel.setText(f"欢迎使用万词斩, {self.username}")
